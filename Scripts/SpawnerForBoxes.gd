...
@export var destroy_distance: float = 0.5  # Adjusted to your requirement
...
@onready var audio_player = $Beeper
...
func _ready():
	...
	var mesh_instance = $LineRenderer  # Ensure you have a MeshInstance3D attached to the cube
