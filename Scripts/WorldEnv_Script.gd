...
var blue_cube_scene = preload("res://SceneInstances/Blue_Box.tscn")  # Path to the blue cube scene
var red_cube_scene = preload("res://SceneInstances/Red_Box.tscn")  # Path to the red cube scene
...
func _on_timer_timeout() -> void:
	...
	if cube_instance.has_method("set_target"):
		cube_instance.call("set_target", Vector3.ZERO, 5.0)  
